...
export const GET_ALL_REPORTS = `SELECT id, project, report, timestamp FROM reports`;
...
export const GET_REPORT_BY_PROJECT_AND_TIMESTAMP = `SELECT id, project, report, timestamp FROM reports WHERE project = ? AND timestamp = ?`;
